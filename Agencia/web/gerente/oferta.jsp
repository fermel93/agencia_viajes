<%-- 
    Document   : oferta
    Created on : 09-04-2016, 12:20:50 PM
    Author     : fernando
--%>
...
<div class="row-fluid">
		<div class="span12">
			<div class="page-header"><!--Cabezado de la pagina-->
				<h1><p class="text-center text-info">Ofertas Vacacionales</p></h1>
			</div>
	</div>
</div>
	<div class="rowfluid">
				...
				<li class="span6">
					<div class="thumbnail">
						...
						<div class="caption text-center">
							<h3>Registro de ofertas vacacionales</h3>
							<p>Registra y manten actualizado tus registros de ofertas vacacionales.</p>
						</div>
					</div>
				</li>
				<li class="span6">
					<div class="thumbnail">
						<div class="caption text-center">
							<form action="#">
								...
								<label for="">Nombre de oferta:</label><input type="text">
								<label for="">Paquete turístico:</label>
        							<select>
