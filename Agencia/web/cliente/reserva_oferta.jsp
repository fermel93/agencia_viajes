<%-- 
    Document   : reserva_oferta
    Created on : 09-04-2016, 12:16:23 PM
    Author     : fernando
--%>
...
<div class="row-fluid">
		<div class="span12">
			<div class="page-header"><!--Cabezado de la pagina-->
				<h1><p class="text-center text-info">Reserva de oferta turística</p></h1>
			</div>
	</div>
</div>
	<div class="rowfluid">
				...
				<li class="span6">
					<div class="thumbnail">
						...
						<div class="caption text-center">
							<h3>Reservación de oferta turística</h3>
							<p>Reserva un paquete turístico en oferta el cual se acomode a tus necesidades.</p>
						</div>
					</div>
				</li>
				<li class="span6">
