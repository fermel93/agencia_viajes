<%-- 
    Document   : vehiculo
    Created on : 09-04-2016, 12:13:47 PM
    Author     : fernando
--%>
...
<div class="row-fluid">
		<div class="span12">
			<div class="page-header"><!--Cabezado de la pagina-->
				<h1><p class="text-center text-info">Vehiculos</p></h1>
			</div>
	</div>
</div>
	<div class="rowfluid">
		<ul class="thumbnails">
				<li class="span6">
					<div class="thumbnail">
						<img src="../img/vehiculos.jpg" alt="">
						<div class="caption text-center">
							<h3>Registro de Vehiculos</h3>
							<p>Registra y manten actualizado tus registros de vehiculos.</p>
						</div>
					</div>
				</li>
				<li class="span6">
					<div class="thumbnail">
						<div class="caption text-center">
							<form action="#">
								...
								<label for="">Marca:</label><input type="text">
								<label for="">Placa:</label><input type="text">
								<label for="">Tipo:</label><input type="text">
								<label for="">Modelo:</label><input type="text">
								<label for="">Año:</label><input type="text">
